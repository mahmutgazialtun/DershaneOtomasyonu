...
namespace loginpage
{
    public partial class PersonelIsleri : Form
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("insert into Personel(Adi,Soyadi,Yasi,CalismaAlani,TelefonNumarasi,Maasi)" +
                "values(@adi,@soyadi,@yasi,@CalismaAlani,@telefonnumarasi,@maasi)", conn);
            ...
            cmd.Parameters.AddWithValue("@calismaalani", textEdit4.Text);
        ...
        public void Guncelle()
        {
            ...
            SqlCommand cmd = new SqlCommand("update Personel set Adi='" + textEdit1.Text + "',Soyadi='" + textEdit2.Text + "',Yasi='" + textEdit3.Text + "',CalismaAlani='" + textEdit4.Text + "',TelefonNumarasi='" + textEdit5.Text + "',Maasi='" + textEdit6.Text + "' where ID='" + id+"'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            Listele();
        }
        public void BilgiCek()
        {
            ...
            textEdit4.Text = gridView1.GetFocusedRowCellValue("CalismaAlani").ToString();
        ...
        public void Sil()
        {
            ...
            if (onay == DialogResult.Yes)
            {
                conn.Open();
                string id = gridView1.GetFocusedRowCellValue("ID").ToString();
                SqlCommand cmd = new SqlCommand("delete from Personel where ID='" + id + "'", conn);
                cmd.ExecuteNonQuery();
                conn.Close();
                Listele();
            }
        ...
        private void PersonelIsleri_Load(object sender, EventArgs e)
        {
            Listele();
        }
        public void Listele()
